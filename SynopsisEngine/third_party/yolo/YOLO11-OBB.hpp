...
namespace utils {
	...
	*/
     ...
     */
    inline void letterBoxObb(const cv::Mat& image, cv::Mat& outImage,
   ...
   inline void drawBoundingBox(cv::Mat &image, const std::vector<ObbDetection> &detections,
     ...
     */
    inline std::vector<cv::Scalar> generateColorsObb(const std::vector<std::string> &classNames, int seed = 42) {
