...
namespace Yolov8Net.Extentions
{
    public static class Utils
    {
        ...
        public static SixLabors.ImageSharp.Image ResizeImage(SixLabors.ImageSharp.Image image,int target_width,int target_height)
        {
            return image.Clone(x => x.Resize(target_width,target_height));
        }

        public static Tensor<float> ExtractPixels(SixLabors.ImageSharp.Image image)
        {
